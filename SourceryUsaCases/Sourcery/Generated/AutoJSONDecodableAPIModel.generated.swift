...
extension Playlist: JSONDecodableAPIModel {
  public init?(json: [String: Any]) {
        guard let title = json["title"] as? String else { return nil }
        self.title = title

        if let creatorJson = json["creator"] as? [String: Any] {
          self.creator = Creator(json: creatorJson)
        } else {
          self.creator = nil
        }
...
extension Playlist.Creator: JSONDecodableAPIModel {
  public init?(json: [String: Any]) {
        guard let name = json["name"] as? String else { return nil }
        self.name = name
